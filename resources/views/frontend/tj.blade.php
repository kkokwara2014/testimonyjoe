...
<body>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('bootstrap2_assets/img/bg-img/testimonyjoe1.jpg')}});">
                <!-- Welcome Content -->
                        ...
                        <div class="row h-100 align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text text-center">
                                    <h2 data-animation="fadeInUpBig" data-delay="100ms">Designed to worship God</h2>
                                    <h5 data-animation="fadeInUpBig" data-delay="400ms">Be a partaker</h5>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('bootstrap2_assets/img/bg-img/30.jpg')}});">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-6">
                                <div class="welcome-text text-center">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Praising God is a privilege</h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">Join us to praise</h5>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('bootstrap2_assets/img/bg-img/testimonyjoe2.jpg')}});">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-6">
                                <div class="welcome-text text-center">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">It's an honour to worship...</h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">Join us to worship</h5>
                                    {{-- <a href="#" class="btn razo-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Book Now</a> --}}
                                </div>
                            </div>
                        </div>
            ...
            <!-- Single Welcome Slide -->
                ...
                <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('bootstrap2_assets/img/bg-img/32.jpg')}});">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-6">
                                <div class="welcome-text text-center">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Unmerited favor of God</h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">Shout for joy</h5>
                                    {{-- <a href="#" class="btn razo-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Book Now</a> --}}
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8">
                    <div class="weekly-news-area mb-50">
                        ...
                        <!-- Featured Post Area -->
                        <div class="featured-post-area bg-img bg-overlay mb-30" style="background-image: url({{asset('bootstrap2_assets/img/bg-img/11.jpg')}});">
                            <!-- Post Overlay -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="razo-single-post d-flex mb-30">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/13.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Post Content -->
                            ...
                            <div class="col-12 col-md-6">
                                <div class="razo-single-post d-flex mb-30">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/14.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="razo-single-post d-flex mb-30">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/15.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="razo-single-post d-flex mb-30">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/16.jpg') }}" alt=""></a>
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta">
                ...
                <div class="col-12 col-md-4">
                    <div class="trending-news-area mb-50">
                        ...
                        <!-- Featured Post Area -->
                        <div class="featured-post-area small-featured-post bg-img bg-overlay mb-30" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/12.jpg') }});">
                            <!-- Post Overlay -->
                            <div class="post-overlay">
                                <div class="post-meta">
                                    <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 2.1k</a>
                        ...
                        <div class="razo-single-post d-flex mb-30">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/17.jpg') }}" alt=""></a>
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta">
                        ...
                        <div class="razo-single-post d-flex mb-30">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/18.jpg') }}" alt=""></a>
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta">
                        ...
                        <div class="razo-single-post d-flex mb-30">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/19.jpg') }}" alt=""></a>
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta">
                        ...
                        <div class="razo-single-post d-flex mb-30">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/20.jpg') }}" alt=""></a>
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <div class="post-meta">
    ...
    <section class="razo-music-charts-area section-padding-80 bg-overlay bg-img jarallax" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/31.jpg') }});">
        <div class="container">
            <div class="row">
                <!-- Section Heading -->
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="100ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/2.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/3.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/4.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="700ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/5.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="900ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/6.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="razo-single-post d-flex mb-30 wow fadeInUp" data-wow-delay="1200ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('bootstrap2_assets/img/bg-img/7.jpg') }}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-meta">
    ...
    <section class="razo-app-download-area section-padding-80-0 bg-img bg-overlay jarallax" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/21.jpg') }});">
        <div class="container">
    ...
    <section class="razo-latest-news-area section-padding-80 bg-overlay bg-img jarallax" style="background-image: url(img/bg-img/32.jpg);">
        ...
        <div class="razo-latest-news-slide owl-carousel">
            ...
            <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/22.jpg') }});">
                <!-- Post Content -->
                <div class="post-content">
            ...
            <!-- Single Latest News Area -->
            <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/23.jpg') }});">
                <!-- Post Content -->
                <div class="post-content">
                    <a href="#" class="post-title">The light and music exposition hits los angeles</a>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
            ...
            <!-- Single Latest News Area -->
            <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url({{ asset('bootstrap2_assets/img/bg-img/24.jpg') }});">
                <!-- Post Content -->
                <div class="post-content">
                    <a href="#" class="post-title">The light and music exposition hits los angeles</a>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
